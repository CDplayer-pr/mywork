      ...
      <div class="manager-main-left">
        <el-menu :default-openeds="['info', 'days','user']" router style="border: none" :default-active="$route.path">
          ...
          <el-submenu index="user">
            ...
            <el-menu-item v-if="false" index="/admin">管理员信息</el-menu-item>
            <el-menu-item v-if="userisVisable" index="/user">学生信息</el-menu-item>
...
export default {
  ...
  methods: {
    ...
    isVisable(){
      if (this.user.role === 'ADMIN') {
        this.userisVisable =true
      }
      if(this.user.role === 'USER'){
        this.userisVisable =false
      }
    }
  }
}
